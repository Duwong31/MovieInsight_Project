...
<body>
    ...
    <header>
        ...
        <a href="index.php" class="logo">
            <img src="/MovieInsightProject/admin/templates/img/icons8-movie-30.png">
        ...
        <nav class="navigation">
            ...
            <form action="" class="search-box">
                ...
                <div class="search-container">
                    <img src="/MovieInsightProject/admin/templates/img/search.png" class="search-icon">
                    <input type="text" name="search" class="search-input" placeholder="Search Movie Insight" id="searchInput">
                    <img src="/MovieInsightProject/admin/templates/img/cross.png" class="clear-icon" id="clearIcon"></i>
                </div>
            </form>
                ...
                <div class="swiper-slide">
                    ...
                    <div class="main-slider-box">
                        ...
                        <div class="main-slider-img">
                            <img src="/MovieInsightProject/admin/templates/img/venom3.jpg" alt="Poster Venom3">
                        </div>
                ...
                <div class="movie-container">
                    <div class="movie-card">
                        <div class="movie-image">
                            ...
                            <img src="/MovieInsightProject/admin/templates/img/substande.jpg" class="movie-thumb" alt="">
