...
<div >
  ...
  <table class="table ">
    ...
    const _CODE = true;
      ...
      $sql="SELECT * from product_size_variation v, product p, sizes s WHERE p.movie_id=v.movie_id AND v.size_id=s.size_id ";
            ...
            <div class="form-group">
              ...
              <select name="product" >
                ...
                <?php
                  ...
                  if ($result-> num_rows > 0){
                    while($row = $result-> fetch_assoc()){
                      echo"<option value='".$row['movie_id']."'>".$row['product_name'] ."</option>";
                    }
                  }
                ?>
              </select>
